...
def main(args):
    ...
    for c_id in range(args.list_len):
        ...
        for i, method in enumerate(methods):
            ...
            args.method = method
            name_tag = (
                f"xdims_{args.x_dim}_C_{args.C[0][0]:.2f}_sig_{args.noise[0][0]:.2f}"
            )
...
# python run_GLVM.py --all_obs 0 --dropout 0.0 --visualise 1 --offline 0 --beta 1 --epochs 1500 --exp "masked" --one_impute 0 --val_impute 1 --random_impute 0 --all 1 --seed 2000
