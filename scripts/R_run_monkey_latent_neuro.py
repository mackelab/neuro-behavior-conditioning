...
def main(args):
    ...
    with open(
        os.path.join("./configs/monkey/R_fit_config.yml"), "r", encoding="utf-8"
    ) as f:
    ...
    if False:
        ...
        with open(data_dir + "PD_train.pkl", "wb") as f:
            pickle.dump(PD_train, f)
        with open(data_dir + "PD_test.pkl", "wb") as f:
            pickle.dump(PD_test, f)
        with open(data_dir + "PD_valid.pkl", "wb") as f:
            pickle.dump(PD_valid, f)
    ...
    group_string = (
        f"{args.masktag}_{net_pars['outputs']}"
    ...
    model.fit(
        ...
        chosen_masks=args.run_params["chosen_masks"],
    )
    print("---------------------------------------")
    print(" ")
    ...
    #     lat_mask=None,
    #     inp_mask=("xa_s",),
    #     test_masks=["all_obs", "xa_m_5", "xa_m_20", "xa_m_50", "xa_m_100", "xa_m_150", "xa_m_200"],
    ...
    for seed in [args.seed]:
        for n_latents in [args.latent_size]:
            ...
            variable_col.add(
                ...
                {
                    "xa_m": "poisson"
                },  # {"xa_m": "poisson", "xb_d": "mse"}, {"xa_m": "poisson"}
            ...
            variable_col.add(
                "chosen_masks",
                ["xa_m_5", "xa_m_20", "xa_m_50", "xa_m_100", "xa_m_150", "xa_m_200"],
            )  # ["xa_m","xb_d"] ["xa_m"],
            ...
            variable_col.add("full_mask_prob", 0.2, 0.5, 1)  #  masked, naive
